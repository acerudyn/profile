                ...
                if(isset($_POST['save'])){
                  ...
                  $sumber    = $_POST['referensi'];
                    ...
                    // Validasi jika gambar tidak diupdate, hanya mengupdte text
                      ...
                      $update		= mysql_query("update berita SET
                                         tanggal      = CURRENT_TIMESTAMP,
                                         judul				=	'$judul',
                    										 isi_berita		=	'$konten',
                                         referensi    = '$sumber'
                    ...
                    <?php }
                			...
                			if(file_exists("../img/berita/".$myData['gambar'])) {
                				unlink("../img/berita/".$myData['gambar']);
                			}
                        ...
                        <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php $_SERVER['PHP_SELF']; ?>" target="_self">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" placeholder="Judul" name="judul" id="tiga" required value="<?php echo $myData['judul']; ?>" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="tiga" class="col-sm-2 control-label">Sumber Referensi</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" placeholder="Referensi" name="referensi" id="tiga" required value="<?php echo $myData['referensi']; ?>" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="tiga" class="col-sm-2 control-label">Isi Berita</label>
                                    <div class="col-sm-10">
                                        <textarea class="form-control konten" placeholder="Isi Berita" name="konten" required><?php echo $myData['isi_berita']; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div id="image-holder">
                                            <?php
                                    if(isset($_GET['id']))
                                        echo "<img src='../img/berita/{$myData['gambar']}'.'?rand='".rand()."' alt=''>";
                                    ?>
                                        </div>
                                        <script>
