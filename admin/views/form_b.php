...
$cost = 10;
$page = password_hash('add_berita', PASSWORD_BCRYPT, [10 => $cost]);
?>
    <style>
        #image-holder {
            margin-top: 8px;
            ...
            <div class="box box-info">
                ...
                if(isset($_POST['save'])){
                  ...
                  // Mengkopi file gambar
                    ...
                    $query  = ("insert into berita (berita_id, tanggal, judul, isi_berita, gambar, referensi) values
                    ('$id', CURRENT_TIMESTAMP,'$judul','$isi','$nama_file','$sumber')");
                    ...
                    <script type="text/javascript">
                        ...
                        document.location = 'home.php?page=<?php echo "$page"; ?>';
                    ...
                    <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php $_SERVER['PHP_SELF']; ?>" target="_self">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" placeholder="Referensi" name="referensi" id="tiga" required />
                                </div>
                            </div>
                            <div class="form-group">
