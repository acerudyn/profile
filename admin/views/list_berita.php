            ...
            <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <?php
                        $cost = 10;
                        $edit = password_hash('edit_berita', PASSWORD_BCRYPT, [10 => $cost]);
                        $delete = password_hash('delete_berita', PASSWORD_BCRYPT, [10 => $cost]);
                        ...
                        while( $row = mysql_fetch_array($result) )
                             {
                                ...
                                <tr>
                                    ...
                                    <td width='100'>{$row['judul']}</td>
                                    <td width='300'>{$row['isi_berita']}</td>
                                    <td width='100'><img src='../img/berita/{$row['gambar']}' border='0' width='90' height='90' /></td>
                                    <td width='100' style='text-align:center'>
                        <a href='home.php?page=$edit&id={$row['berita_id']}'>
                        ...
                        <a href='home.php?page=$delete&id={$row['berita_id']}'>
