	...
	<section id="portfolio">
        <div class="container">
          ...
          <!--
					...
					<li><a class="btn btn-default" href="#" data-filter=".bootstrap">EDC & Pinpad</a></li>
					<li><a class="btn btn-default" href="#" data-filter=".html">UPS</a></li>
					<li><a class="btn btn-default" href="#" data-filter=".wordpress">TCR</a></li>
          <li><a class="btn btn-default" href="#" data-filter=".wordpress">KiosK</a></li>
        -->
				</ul><!--/#portfolio-filter-->
...
$sql = "select * from produk where merk='$kategori' ";
...
<!-- menampilkan daftar produk menggunakan php -->
						<div class="portfolio-item apps col-xs-12 col-sm-4 col-md-3">
							<div class="recent-work-wrap">
								<img class="img-responsive" src="../admin/img/produk/<?php echo $data['gambar'] ?>" alt=""
                                     width="290" height="220">
								<div class="overlay">
									<div class="recent-work-inner">
                                        <!-- Hover Product-->
										<h3><a href="#"><?php echo $data['nama_produk'] ?></a></h3>
										<p><?php echo substr($data['spesifikasi'],0,117); ?></p>
                    <a class="preview" href="detail.php?id=<?php echo $data[0] ?>"><i class="fa fa-eye"></i> View More |</a>
										<a class="preview" href="../admin/img/produk/<?php echo $data['gambar'] ?>" rel="prettyPhoto"><i class="fa fa-eye"></i> View Image</a>
									</div>
								</div>
							</div>
						</div><!--/.portfolio-item-->
